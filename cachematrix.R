...
## which can be compuationaly intensive
##
## Example Usage:
##
...
## get and set the value of the solved matrix
...
## The following function returns the inverse the matrix created with the above function makeCacheMatrix.
## It first checks to see if the matrix has inverse been calculated with getSolved.
